...
<link
	href="<c:url value='/template/web/assets/css/skins/skin-demo-20.css'/>"
	rel="stylesheet">
...
<body>
	...
	<script type="text/javascript"
		src="<c:url value='/template/web/assets/js/jquery.twbsPagination.js'/>"></script>
	...
	<script
		src="<c:url value='/template/web/assets/js/nouislider.min.js'/>"></script>

	<script
		src="<c:url value='/template/web/assets/js/bootstrap-input-spinner.js'/>"></script>

	<script src="<c:url value='/template/web/assets/js/wNumb.js'/>"></script>
	<script
		src="<c:url value='/template/web/assets/js/jquery.elevateZoom.min.js'/>"></script>
